...
<p>Nawiązujemy współpracę bezpośrednio z producentami. Dzięki temu często dostajemy dla czytelników kody rabatowe, bonusy i tańsze zestawy, których nie ma w zwykłej sprzedaży. Aktualne kody są na stronie sprzętu, w newsletterze i na Telegramie.</p>
...
<p>We work directly with gear makers. That often gets our readers discount codes, bonuses and cheaper bundles you won't find elsewhere. Current codes are on the gear page, in the newsletter and on Telegram.</p>
<h2>What partners pay us for</h2>
<ul><li>Sales through our code or link. The partner may pay us a commission. You never pay more, and with a code usually less.</li>
<li>Gear tests and features. A maker may provide gear for testing or pay for a feature. We always label it, and makers never approve our text before publication.</li>
<li>Digital products. Extended checklists and PDF guides.</li></ul>
...
<li>Miejsce w rankingach i checklistach, jeśli produkt przejdzie test.</li>
<li>Kod rabatowy dla naszej społeczności, ogłaszany na stronie, w newsletterze i na Telegramie.</li>
<li>Rozliczenie od sprzedaży z kodu albo stała opłata za prezentację.</li></ul>
<h2>Czego potrzebujemy od partnera</h2>
<ul><li>Egzemplarza do testu albo wypożyczenia.</li>
<li>Kodu rabatowego na wyłączność dla PrepReady.</li>
<li>Zgody na niezależny test. Publikujemy też minusy.</li></ul>`,
  },
  en: {
...
<li>A place in our rankings and checklists, if the product passes.</li>
<li>A discount code for our community, announced on the site, in the newsletter and on Telegram.</li>
<li>Revenue share on code sales or a flat fee for a feature.</li></ul>
<h2>What we need from a partner</h2>
<ul><li>A test unit or a loan.</li>
<li>An exclusive discount code for PrepReady.</li>
<li>Agreement that the test is independent. We publish downsides too.</li></ul>`,
  },
};
