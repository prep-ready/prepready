...
export const ui = {
  pl: {
    ...
    'news.eyebrow': 'Feed · źródła urzędowe i media, aktualizacja codzienna',
    'news.title': 'Co się dzieje i co to znaczy dla Ciebie',
    'news.forYou': 'Dla Ciebie',
    'news.all': 'Wszystko', 'news.weather': 'Pogoda', 'news.energy': 'Energia', 'news.security': 'Bezpieczeństwo', 'news.health': 'Zdrowie',
    ...
    'aff.disclose': 'Linki partnerskie: jeśli kupisz, możemy dostać prowizję. Nie wpływa to na kolejność ani oceny.',
    'aff.how': 'Jak zarabiamy',
    ...
    'gear.sub': 'Mierzymy realną pojemność, czas ładowania z gniazdka i ile razy naładują telefon.',
    ...
    'f.team': 'O nas i redakcja', 'f.earn': 'Jak zarabiamy', 'f.method': 'Metodologia indeksu',
  ...
  en: {
    ...
    'idx.eyebrow': 'Readiness Index · Poland & EU',
    ...
    'news.eyebrow': 'Feed · official sources and media, updated daily',
    'news.title': "What's happening and what it means for you",
    'news.forYou': 'For you',
    'news.all': 'All', 'news.weather': 'Weather', 'news.energy': 'Energy', 'news.security': 'Security', 'news.health': 'Health',
    'news.more': 'All news →',
    ...
    'aff.disclose': 'Affiliate links: if you buy, we may earn a commission. It never changes rankings or scores.',
    'aff.how': 'How we make money',
    ...
    'gear.sub': 'We measure real capacity, wall-charge time and how many phone charges you get.',
    ...
    'f.team': 'About & editors', 'f.earn': 'How we make money', 'f.method': 'Index methodology',
