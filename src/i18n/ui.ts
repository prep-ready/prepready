...
export const ui = {
  pl: {
    ...
    'nl.btn': 'Zapisz mnie', 'nl.small': 'Zapisując się, zgadzasz się na newsletter PrepReady. Bez spamu, wypiszesz się jednym kliknięciem.', 'nl.placeholder': 'twoj@email.pl',
    'nl.pending': 'Zapis ruszy po podłączeniu narzędzia do newslettera.',
    'nl.ok': 'Dzięki! Jesteś na liście. Pierwszy raport w najbliższy piątek.', 'nl.err': 'Nie udało się zapisać. Spróbuj ponownie za chwilę.',
  ...
  en: {
    ...
    'nl.btn': 'Sign me up', 'nl.small': 'By signing up you agree to receive the PrepReady newsletter. No spam, one-click unsubscribe.', 'nl.placeholder': 'you@email.com',
    'nl.pending': 'Sign-up goes live once the newsletter tool is connected.',
    'nl.ok': "Thanks! You're on the list. The first report arrives this Friday.", 'nl.err': "Couldn't sign you up. Please try again in a moment.",
